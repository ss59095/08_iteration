...
nematode <- read.csv("../Data/nematode_rs.csv")
...
for (i in 3:ncol(nematode_w)) {
  ...
  # Print a message
    print(paste("Finished with variable",
                 varname))
}
```
